                ...
                <form action="{{ route('dashboard.products.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    @foreach (config('translatable.locales') as $locale)
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="{{ $locale }}[name]" class="form-control" value="{{ old($locale . '.name') }}"   id="name">
                        </div>
                    ...
                    <div class="form-group">
                        <img src="{{ asset('uploads/product_images/default.png') }}" style="width: 80px" class="img_thumbnail image-preview" alt="">
                    </div>
